...
public abstract class TileLayer {
    ...
    public TileLayer(Map<String, Object> cache, int y, int tileWorldX, int tileWorldZ, int size, int sampleResolution, ServerLevel level, WorldScreenv2 screen) {
    ...
    public interface Factory {
        ...
        TileLayer make(Map<String, Object> cache, int scrollWorldY, int tileWorldX, int tileWorldZ, int size, int sampleResolution, ServerLevel level, WorldScreenv2 screen);
    }
}
